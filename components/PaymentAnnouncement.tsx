  ...
  return (
    ...
    >
      ...
      <p className="mt-2 max-w-3xl break-words text-sm leading-6 text-neutral-400">
        A SQUARE SERVICE FEE applies to card and digital-wallet payments. Cash is accepted during tournament-morning registration with no service fee. Supported contactless wallets can be used through the Square reader.
      </p>
