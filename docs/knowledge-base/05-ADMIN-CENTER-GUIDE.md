...
| `/admin/tournament-manager/photos` | Complete **Winner Photos & Recap**. | Champion photo, Big Bass photo, and a 300-character maximum Tournament Recap. | Step 4 is ready only when all three are present; recap remains editable after publication without reopening the event. |
