  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-black text-white">
      ...
      <PageHeader
        ...
        compact
        subtitle="Support competitive bass fishing and connect your business with the AITT community."
        title="Sponsors"
      />

      <section
        aria-labelledby="partnership-heading"
        className="mx-auto min-w-0 max-w-5xl px-5 py-12 sm:px-6 sm:py-16"
      >
        ...
        <h1
          ...
          className="mt-3 break-words text-3xl font-black uppercase tracking-tight text-white sm:text-4xl"
        >
