...
export async function buildRegistrationWorkbook(
  ...
  zip.file("docProps/core.xml", `<?xml version="1.0" encoding="UTF-8" standalone="yes"?><cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/"><dc:title>${escapeXml(`${options.tournamentName} Registration Roster`)}</dc:title><dc:subject>${escapeXml(`Active registration roster exported ${exportedAt}`)}</dc:subject><dc:creator>All-In Tournament Trail</dc:creator><cp:lastModifiedBy>All-In Tournament Trail</cp:lastModifiedBy></cp:coreProperties>`);
