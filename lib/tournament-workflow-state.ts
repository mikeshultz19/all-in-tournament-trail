...
export function resolveTournamentWorkflowState(
  ...
  return [
    ...
    { number: 4, title: "Generate Checks", status: payoutStatus, nextStep: insuranceComplete ? "Review payouts and generate checks" : "Complete the Insurance Pot before generating checks", description: "Review every tournament payout and generate the final checks.", locked: !importComplete || !insuranceComplete },
